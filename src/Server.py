...
def Main():
    ...
    parser.add_argument("-c", "--conn", type=int, default=4, dst='max_connections',
                        help="Max number of collections allowed (default 4)")
    parser.add_argument("-d", "--difficulty", type=int, default=20, dst='difficulty',
                        help="Difficulty of mining (default 20)")
    parser.add_argument("-l", "--length", type=int, default=15, dst='max_length_chain',
